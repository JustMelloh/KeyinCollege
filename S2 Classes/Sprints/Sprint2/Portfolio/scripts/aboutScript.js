document.addEventListener('DOMContentLoaded', function () {
    ...
    aboutBtn1.addEventListener('click', function () {
        ...
        aboutBox1Text.style.display = (aboutBox1Text.style.display === 'none' || aboutBox1Text.style.display === '') ? 'block' : 'none';
    });

    aboutBtn2.addEventListener('click', function () {
        // Toggle the display of aboutBox2 text when the button is clicked
        aboutBox2Text.style.display = (aboutBox2Text.style.display === 'none' || aboutBox2Text.style.display === '') ? 'block' : 'none';
    });
});